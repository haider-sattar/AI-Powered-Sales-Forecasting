...
# ===============================
joblib.dump(model, "../data/prophet_model_basic.pkl")
forecast[['ds','yhat','yhat_lower','yhat_upper']].to_csv("../data/forecast_basic.csv", index=False)
print("Baseline model and forecast saved.")
